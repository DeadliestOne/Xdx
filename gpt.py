...
# Bot API Token
API_TOKEN = '7571130552:AAEG4RzTbLLibOS0wICJwgTkIFMF1d402uI'
API_ID ='26416419'
API_HASH ='c109c77f5823c847b1aeb7fbd4990cc4'
# OpenAI API Key
openai.api_key = "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"
#Only owner id
DEVIL = "6748827895"
# MongoDB setup
MONGODB_URI = "mongodb+srv://devine:0k2ZZb9yrter5HCM@cluster0.tc92y.mongodb.net/?retryWrites=true&w=majority"  # Set your MongoDB connection string here
client = pymongo.MongoClient(MONGODB_URI)
db = client["wormgpt"]
collection = db["allowed_users"]
allowed_users = ["K_HACKER_ANONYMOUS", "UncountableAura"]
owners = ["K_HACKER_ANONYMOUS", "UncountableAura"]
