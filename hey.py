...
# Update the `/host` and `/forward` commands, keeping their previous structure, to use inline buttons where possible.

# Other parts of the code remain the same, ensuring `/host`, `/forward`, OTP handling, and forwarding functionality work seamlessly.
